...
function CourseForm() {
  ...
  const [provider, setProvider] = useState(""); // this filed its optional
  ...
  return (
    ...
    <div className="main-content">
      <div className="form-container animate__animated animate__fadeInUp">
        <h1 className="animate__animated animate__fadeIn">{courseId ? "Edit Goal" : "Add New Goal"}</h1>
        ...
        {/* ________________________________________________________________________________________________________________ */}
          ...
          <button type="submit" className="btn btn-save animate__animated animate__pulse animate__infinite animate__slow">{courseId ? "Update Goal" : "Create Goal"}</button>
